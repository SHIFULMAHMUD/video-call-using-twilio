package com.android.videoapp.activity;
...
import com.android.videoapp.BuildConfig;
import com.android.videoapp.R;
import com.android.videoapp.dialog.Dialog;
import com.android.videoapp.util.CameraCapturerCompat;
...
public class VideoActivity extends AppCompatActivity {
     ...
     */
    private static final String TWILIO_ACCESS_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..cyJYqICbReCW6l1fwrv90-6cOLzdsv5gjQModSGq4gM";
    private static final String ACCESS_TOKEN_SERVER = "https://peach-shark-2060.twil.io/video-token?identity=rohan";
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnected(Room room) {
                ...
                Toast.makeText(VideoActivity.this, room.getName(), Toast.LENGTH_SHORT).show();
    ...
    private void retrieveAccessTokenfromServer() {
        Ion.with(this)
                .load(ACCESS_TOKEN_SERVER)
                .asString()
                .setCallback(
                        (e, token) -> {
                            if (e == null) {
                                VideoActivity.this.accessToken = token;
//                                Log.e("token",VideoActivity.this.accessToken);
                            } else {
                                Toast.makeText(
                                                VideoActivity.this,
